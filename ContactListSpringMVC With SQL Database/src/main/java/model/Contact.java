...
public class Contact {
    ...
    @Length(max = 50, message = "Last Name must be no more than 50 characters")
    private String lastName;
    @NotEmpty(message = "You Must Supply a value for Company")
    @Length(max = 50, message = "Company must be no more than 50 characters")
    private String company;
    @NotEmpty(message = "You Must Supply a value for Phone")
    @Length(max = 10, message = "Phone must be no more than 10 characters")
    private String phone;
    @Length(max = 50, message = "Email must be no more than 50 characters")
