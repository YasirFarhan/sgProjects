...
public class UserController {
    ...
    @RequestMapping(value = "/enableOrDisableUser", method = RequestMethod.GET)
    public String enableOrDisableUser(@RequestParam("username") String username,
            Map<String, Object> model) {
        userService.enableOrDisableUser(username);
        return "redirect:displayUserList";
    }

//
//    @RequestMapping(value = "/enableOrDisableUser", method = RequestMethod.POST)
//    public String enableOrDisableUser(HttpServletRequest req) {
